...
<?php $__env->startSection('title', 'Edit Member - Group 6'); ?>
...
<div class="max-w-3xl mx-auto px-4">
    ...
    <div class="member-card p-8">
        ...
        <form method="POST" action="<?php echo e(route('admin.members.update', $user)); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="relative inline-block">
                        <div class="profile-avatar mx-auto" style="width: 96px; height: 96px; overflow: hidden; border-radius: 50%;">
                            <?php if($user->profile_photo): ?>
                                ...
                                <img src="<?php echo e(url('storage-file/' . $user->profile_photo)); ?>"
                                     alt="<?php echo e($user->name); ?>"
                                     id="preview"
                                     class="w-full h-full object-cover">
                            <?php else: ?>
                                <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($user->name)); ?>&background=3b5570&color=fff&size=96"
                                     alt="<?php echo e($user->name); ?>"
                                     id="preview"
                                     class="w-full h-full object-cover">
                            <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="age" value="<?php echo e(old('age', $user->age)); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-7">
                ...
                <textarea name="bio" rows="3" class="form-textarea"
                          placeholder="Brief description about this member..."><?php echo e(old('bio', $user->bio)); ?></textarea>
                <?php $__errorArgs = ['bio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Group_6_@IT_Elective_2\resources\views/admin/edit-member.blade.php ENDPATH**/ ?>